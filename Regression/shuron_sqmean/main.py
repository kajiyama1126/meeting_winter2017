...
Gamma_x = (C_P * C_theta * d_hat * upper_w* (m* n*(beta**2 + 1))**0.5)/(mu_x-rho)*(1-(rho/mu_x)**iteration)
Gamma_v = (C_P * C_theta * d_hat * upper_w*(m* n)**0.5)/(mu_x-rho)*(1-(rho/mu_x)**iteration)
