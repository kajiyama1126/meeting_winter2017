...
class Agent_harnessing_quantize_add_send_data_shuron_jikken2(Agent_harnessing_quantize_add_send_data):
    def __init__(self, n, m, A, b, eta,weight, name,mu_x,C_h,h_0):
        super(Agent_harnessing_quantize_add_send_data_shuron_jikken2, self).__init__(n, m, A, b, eta,weight,name)
        self.h_x=h_0
